...
At every company I've worked at we've had similar challenges. From a 5 year old React codebase when working with [Xploro](https://xploro.health), various legacy SAAS products at [Corporation Pop](https://corporationpop.co.uk), taking on an agencies codebase when at [Chatloop](https://chatloop.com) and more in previous companies
