...
<h3 class="text-primary text-xl font-medium pt-6 mb-4">The Programming Paradox</h3>
...
<h3 class="text-primary text-xl font-medium pt-6 mb-4">Two Sides of the Same Tool</h3>
